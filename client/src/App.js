...
class App extends Component {
    ...
    callGetBrandsRequest() {
        fetch("http://localhost:9000/api/brands")
            ...
            .then(jsonResponse =>
                this.setState({
                    brands: jsonResponse.data.wishList
                })
            )
    }
                    ...
                    <div className="header-bag__item header-bag__count">
                        ...
                        <svg className="icon" width="17px" height="18px" viewBox="36 8 17 18" version="1.1"
                            ...
                            <path
                                ...
                                id="Bag-Icon" stroke="none" fill-rule="evenodd"></path>
                        </svg>
            ...
            <main className="product-page">
                <div className="container">
                    <div className="product-controls">
                        <label className="product-controls__label" for="Brands-Filter">Brands</label>
                        ...
                        <label className="product-controls__label" for="Sort">Sort</label>
                        ...
                        <li className="product-list__item">
                            <article className="product" itemscope itemtype="http://schema.org/Product">
                                ...
                                <div className="product__details">
                                    ...
                                    <button className="product__add-to-cart button button--primary button--in-cart">In
                                        Cart
                                    </button>
                                </div>
                            </article>
                        ...
                        <ul className="pagination__list">
                            <li className="pagination__item">
                                <a href="#" className="pagination__link">
                                    <svg className="icon" width="8px" height="10px" viewBox="18 18 8 10" version="1.1"
                                         xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                        ...
                                        <polygon id="Left-Icon" stroke="none" fill-rule="evenodd"
                                                 ...
                                                 points="22.9427745 22.9999999 19 26.9458774 20.0541226 28 25.0541226 23 20.0541226 18 19 19.0541226"></polygon>
                                    </svg>
                                </a>
                            </li>
                            <li className="pagination__item">
